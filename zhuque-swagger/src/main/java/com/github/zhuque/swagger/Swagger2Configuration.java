 ...
 * Swagger2 启动类
 * 启动条件：
 * 1，配置文件中zhuque.swagger.enabled=true
 * 2，配置文件中不存在：zhuque.swagger.enabled 值
 *
 * @author zhuque
...
public class Swagger2Configuration implements WebMvcConfigurer {
    ...
    public static class ZhSecurityConfiguration {
        ...
        @ConditionalOnProperty(name = "zhuque.swagger.production", havingValue = "true")
        ...
        @Bean
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "zhuque.swagger.basic.enable", havingValue = "true")
        ...
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "zhuque.swagger.markdown.enable", havingValue = "true")
